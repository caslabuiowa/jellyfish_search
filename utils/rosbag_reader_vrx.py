...
if __name__ == '__main__':
    ...
    gps_reader = Reader(filepath=fname, topics=['/wamv/sensors/position/ground_truth_odometry'])
    ...
    # Obstacles
    ###
    obstacle_fname = '/home/magicbycalvin/ros2_ws/src/jellyfish_search/config/short_navigation_course_2.json'
    ...
    ax1.plot(gps[:, 0], gps[:, 3], label=r'$\psi_\mathrm{gps}$')
    ax1.plot(t_ref, psi_ref, label=r'$\psi_\mathrm{ref}$')
